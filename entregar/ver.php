...
$busca_maxima_compra_usuario="SELECT x.folio, x.fecha_venta, y.nombre, y.apellidop, y.apellidom, y.rfc from entrega x, productor y where x.fk_productor=y.pk_productor and x.folio='$folio'";
...
$query="SELECT pk_carrito,fk_venta,fk_nombre_producto, SUM(cantidad) as canti, costo_sugerido,SUM(subtotal) as sub FROM carrito where fk_venta='$folioo' group by fk_nombre_producto";
    
    $resultado=$con->query($query); 


$querys="SELECT total_vendido FROM entrega where folio='$folioo'";
...
<div class="col-md-4"><h3>Folio de venta: <?php echo $folio; ?></h3><h3>Fecha:  <?php echo $fecha;?> </h3></div>
</div>
...
<a href="../vistas/admin.php"><button class="button2">SALIR</button></a>
